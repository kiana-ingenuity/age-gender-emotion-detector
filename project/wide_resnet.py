...
# K, the widening factor, which multiplies the number of feature channels in each convolution layer.
# (table 5 on page 8 indicates best value for k,depth)
# (table 6 on page 10 indicates best value for probability)
...
class WideResNet:
    def __init__(self, image_size, depth=16, k=8):
        ...
        self._weight_decay = 0.0005      # page 10: "Used in all experiments"
       
    
    # config from code throughtout all layer:
        self._use_bias = False           # following functions 'FCinit(model)' and 'DisableBias(model)' in utils.lua
        self._weight_init = "he_normal"  # follows the 'MSRinit(model)' function in utils.lua
...
#    def create_model(self):
    def __call__(self):
        ...
        # the number of layers can be calculated by the formula : nb_layers = 4 + 6 * N
